...
-(void) notifyHandDidEnd{
    ...
    [notificationCenter postNotificationName:kNotificationGameDidEnd
        ...
        // dealer done if they have drawn 5 cards
            ...
            if (dealerScore >= 17) {
                ...
                if (playerScore > dealerScore) {
                    ...
                    // better to the player's score
                    //keep playing, dealer will play another card
                }
                else {
                    //dealer has equaled or beaten the player so the
                    //game is over
                    _didDealerWin = YES;
                    _money -= _bet;
                    _gameStage = kGameStageGameOver;
